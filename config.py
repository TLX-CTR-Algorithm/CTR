...
ffm_train_path = os.path.join(BASE_DIR, "output/model_data/train_ffm.txt.bin")
ffm_valid_path = os.path.join(BASE_DIR, "output/model_data/valid_ffm.txt.bin")
ffm_test_path = os.path.join(BASE_DIR, "output/model_data/test_ffm.txt.bin")
