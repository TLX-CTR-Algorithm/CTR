...
def test_model(batch_size=FLAGS.batch_size):
    ...
    with tf.Session(graph=loaded_graph) as sess:
        ...
        model_continous_inputs, model_categorial_inputs, model_label, model_keep_prob,model_prediction = get_tensors(loaded_graph)
        ...
        for step in range(math.ceil(len(inputs)/batch_size)):
            ...
            feed_dict = {model_categorial_inputs: categorial_inputs, model_continous_inputs: continous_inputs,model_keep_prob: FLAGS.keep_prob}
