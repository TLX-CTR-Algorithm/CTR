...
preprocess.create_feature(data_path=dnsp_data_dir, datadir=fe_gen_dir, filename='dnsp_train.csv')
preprocess.create_feature(data_path=test_path, datadir=fe_gen_dir, filename='test.csv')

preprocess.preprocess(datadir=fe_gen_dir, outdir=model_data_dir,continous_features=continous_features,categorial_features=categorial_features)
